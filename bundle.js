  ...
  return (function (e) {
        ...
        var n = {},
          ...
          o = function (t) {
            return (
              ...
              (("FORM" != e.tagName || "submit" != t) &&
                !d.isCustomEvents &&
                (d.isFF && d.isFF < 9
                  ? !document.createEvent("event")[t.toUpperCase()]
                  : void 0 === e["on" + t]))
            );
          },
          r = function (t, i) {
          ...
          s = function (t) {
            if (!(t in i)) {
                ...
                for (o = 0; o < s; o++)
                  try {
                    ...
                    !1 ===
                      r[o].call(
                        e,
                        d.isCustomEvents && i instanceof d.CustomEvent
                          ? i.detail
                          : i
                      ) && (a = !1);
                  } catch (e) {
              ...
              e.attachEvent
                ? e.attachEvent("on" + t, i[t])
                : e.addEventListener && e.addEventListener(t, i[t], !1);
            }
          },
          a = function (t) {
            var o = i[t];
            if (o) {
              e.attachEvent
                ...
                : e.addEventListener && e.removeEventListener(t, o, !1);
              delete i[t];
              delete n[t];
            }
          },
    ...
    function (e, t, n) {
      function i() {
        ...
        var s,
          ...
          C = document.documentMode || d,
          S = -1 !== u.indexOf("windows") || -1 !== u.indexOf("win32"),
          ...
          V = "textContent" in document.createElement("div"),
          j = !1,
          U = null;
        try {
          if (
        ...
        return {
          ...
          hasJava: (function () {
            var e = c.mimeTypes;
            return d
              ? !O && "javaEnabled" in c && c.javaEnabled()
              : e && (e = e[Y]) && (e = e.enabledPlugin)
              ? e.name
              : void 0;
          })(),
          language: P,
    ...
    function (e, t, n) {
      ...
      function r(e) {
        ...
        var t =
          "widget-mediator." +
          ((d.brandDomain && d.brandDomain.replace(/:[0-9]+/, "")) ||
            "zopim.com");
        return e || t;
      }
      var s = n(1),
    ...
    function (e, t, n) {
      function i(e, t) {
        for (
          var n, i = document.createElement("div"), o = 0, r = P.length;
          o < r;
          o++
        )
          if (void 0 !== i.style[P[o]]) {
            n = t[o];
            break;
          }
        return n
      ...
      function r() {
        for (
          var e, t, n = arguments.length, i = 1, o = arguments[0] || {};
          i < n;
          i++
        )
      ...
      function L(e, t, n) {
        return S.AUTH_URL.replace("$NAME", e)
          .replace("$KEY", t)
          .replace("$MID", n);
      }
      var x,
        ...
        P = ["transition", "MozTransition", "OTransition", "WebkitTransition"],
        M = [
          "transitionend",
          "transitionend",
          "otransitionend",
          ...
          contains: (function () {
            ...
            return e.compareDocumentPosition
              ...
              ? function (e, t) {
                  ...
                  return (
                    e === i ||
                    !!(i && 1 === i.nodeType && n.contains && n.contains(i))
                  );
                }
              : function (e, t) {
                  e = e.dom || e;
          ...
          if (r(a))
            if (1 !== a.length || !0 !== a[0])
              for (n = 0, o = a.length; n < o; n++)
                u.push(s + "=" + window.encodeURIComponent(a[n] + ""));
            else u.push(s);
    ...
    function (e, t, n) {
      function i(e, t) {
        ...
        if (r(e.bind) && !("prototype" in e.bind))
    ...
    function (e, t, n) {
      function i(e, t) {
        ...
        else for (var r in t) t.hasOwnProperty(r) && i.add(r, t[r]);
        return i;
      }
      function o() {
        function e(e, t) {
        ...
        for (
          var u = {},
            ...
            f = ["concat", "replace", "toLowerCase", "toUpperCase"],
            h = 0;
          h < f.length;
          h++
        )
              ...
              v.ensureLoaded(c, function (i) {
                ...
                if (e == w) {
                  for (t = 0, n = y.length; t < n; t++)
                    y[t].update instanceof Function && y[t].update(e);
                  for (t = 0, n = b.length; t < n; t++) {
                    o = b[t];
                    r = $[t].toString();
                    if (k) o.textContent = r;
                    else if ("string" == typeof o.innerText) o.innerText = r;
                    else if ("string" == typeof o.nodeValue)
                      try {
                        o.data = r;
                      } catch (e) {}
                  }
    ...
    function (e, t, n) {
      ...
      function a(e) {
        if (h) {
          +new Date() - h.issued_at >= h.expires_in - 6e4
            ? y.authenticate(function (t) {
                if (t) {
    ...
    function (e, t, n) {
      ...
      function o(e) {
        return function (t) {
          ...
          return new _(
            'Expect "' + t + '" to fulfill at least one condition',
            t
          );
        };
      }
      function r(e) {
        return function (t) {
          if (t !== e)
            return new _('expect "' + t + '" to equal "' + e + '"', t);
        };
      }
      function s(e, t) {
        return function (n) {
          if ("object" != typeof n || !n)
            return new _('Expect "' + n + '" to be an object', n);
          if (t && t.requiredKeys)
      ...
      function a(e) {
        return function (t) {
          if (typeof t !== e)
            return new _('Expect "' + t + '" to have type "' + e + '"', t);
        };
      }
      function c() {
        return function (e) {
      ...
      function u(e) {
        return function (t) {
          e.lastIndex = 0;
          if (!e.test(t))
            return new _('Expect "' + t + '" to match predefined format', t);
        };
      }
      function l(e) {
        return function (t) {
          if (t.length < e)
            return new _(
              'Expect the length of "' + t + '" to be at least ' + e,
              t
            );
        };
      }
      function d(e) {
        return function (t) {
          if (t.length > e)
            return new _(
              'Expect the length of "' + t + '" to be at most ' + e,
              t
            );
        };
      }
    ...
    function (e, t, n) {
      function i(e, t, n) {
        s.ok(
          "function" == typeof e,
          "1st argument to nextTick must be a function"
        );
        if (n)
      ...
      function i(e) {
        ...
        i.$Loader = {
          cleanup: function () {
            s(function () {
              i.$Loader.payload
                ? i.fire("success", i.$Loader.payload)
                : i.fire("error");
          ...
          try {
            ...
            this.doc.write(
              '<html><head><script src="' +
                e +
                '"></script><script>document.addEventListener && document.addEventListener("DOMContentLoaded", function() {try { $Loader.cleanup() } catch(e) {}})</script></head><body></body></html>'
            );
            this.doc.close();
          } catch (e) {
            this.$Loader.cleanup();
    ...
    function (e, t) {
      ...
      var c,
        ...
        v,
        y,
        w = ["idle_disconnect", "shutdown", "error"],
        b = {
          init: n,
          reset: o,
          destroy: i,
            ...
            settings: {
              ...
              forms: {
                ...
                post_chat_form: {
                  ...
                  message$string: i(
                    "How would you rate the chat experience you just had?"
                  ),
                  ...
                  comments_messages: {
                    good: {
                      ...
                      placeholder$string: i(
                        "What did you like about this chat?"
                      ),
                    },
                    bad: {
                      message$string: i(
                      ...
                      placeholder$string: i(
                        "What did you dislike about this chat?"
                      ),
                    },
                  },
                },
    ...
    function (e, t) {
      ...
      ("function" == typeof o && /\[native code\]/.test(o.toString())) ||
        (o = n);
      e.exports = i;
    },
    function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      function s(e, t) {
        ...
        f.$("livechat")
          ...
          .write({
            timestamp$int: n,
            nick$string:
              f.$("livechat").$("profile").$("nick$string").getValue() || "",
            display_name$string:
              f
                .$("livechat")
                .$("profile")
      ...
      function a(e, t) {
        function n(e) {
          if ("ok" !== e.raw.__status)
            return t(new window.Error(d(e.raw.error)));
          if (!e.raw.data || "chat.file" !== e.raw.data.type)
            return t(new window.Error("INTERNAL_ERROR"));
          t(
            null,
            b.pick(e.raw.data, ["mime_type", "name", "size", "url", "metadata"])
          );
        }
        ...
        if (m(i))
          ...
          var o = h.registerCallback(n),
            r = "https://" + i.host + v.CALLBACK_FILE_UPLOAD_PATH,
            s = {
            ...
            c = {
              ...
              load: function () {
                if (200 !== this.status) {
                  ...
                  t(
                    e && e.error
                      ? new window.Error(d(e.error))
                      : new window.Error("INTERNAL_ERROR")
                  );
                }
              },
            };
      ...
      function c(e, t) {
        ...
        var i = s(
          ...
          o = "https://" + n.host + v.FILE_UPLOAD_PATH,
          r = {
            ts: i,
          },
          a = {
      ...
      function u(e) {
        ...
        var t = f.$("livechat"),
          ...
          r = (n.$("allowed_extensions$string").getValue() || "")
            .trim()
            .replace(/\s*,\s*/g, ",")
            .split(","),
          s =
    ...
    function (e, t, n) {
      ...
      i.prototype.process_data = function (e) {
        if (e && !this._abort) {
          ...
          this.longpoll &&
            this.longpoll.load(this.url + ["p", +new Date()].join("/"));
        }
      };
      i.prototype.send = function (e) {
        if (this._abort) return !1;
        var t =
          this.url + ["d", +new Date(), window.encodeURIComponent(e)].join("/");
      ...
      function i(e) {
        function t(e) {
          ...
          e.origin == i &&
            ("event-stream" == e.data
              ? (s.onload = null)
              : r.onmessage && r.onmessage(e.data, c));
        }
        var n,
          i,
          r = this,
    ...
    function (e, t, n) {
      function i(e) {
        function t(e) {
          ...
          u = u.split("\n\n");
          for (var t = 0; t < u.length - 1; t++)
            s.onmessage && s.onmessage(u[t], n);
          u = u[u.length - 1];
      ...
      var o = n(2),
        r = o.isIE
          ...
          : !o.isOpera && !o.isAndroid && window.XMLHttpRequest,
        s = r ? i : null,
        a = o.isIE ? "//" : "https://";
      i.protocol = "cxhr";
      i.prototype.send = function (e) {
    ...
    function (e, t, n) {
      function i(e, t, n, o) {
        ...
        this.status =
          window.navigator && !1 === window.navigator.onLine
            ? "offline"
            : "connecting";
        this.connected = !1;
        this.quality = 0;
        ...
        this.reconnect_delay =
          o.RECONNECT_DELAY_MS * (0.2 * Math.random() + 0.8);
      ...
      i.prototype.connect = function (e) {
        ...
        if (!this.reconnect_timer) {
          ...
          !n.PREFERRED_PROVIDER &&
            i &&
            (this.provider = 1 & this.connect_attempts ? g : m);
      ...
      i.prototype._onclose = function () {
        ...
        this.time_last_alive > 0 &&
          this.idle_time.add(Date.now() - this.time_last_alive);
        this.time_last_open > 0 &&
          this.connected_time.add(Date.now() - this.time_last_open);
      ...
      var v = Math.pow(50, 0.1),
        y = Math.pow(1e3, 0.1) - v;
      i.prototype.calculate_clocks = function (e, t, n) {
        ...
        this.smooth_skewed_transit_time_in
          ? (this.smooth_skewed_transit_time_in =
              r * this.smooth_skewed_transit_time_in + (1 - r) * i)
          : (this.smooth_skewed_transit_time_in = i);
        ...
        if (
          ...
          this.rtt =
            this.smooth_skewed_transit_time_in +
            this.remote_smooth_skewed_transit_time_out;
          this.quality = ~~(100 * (1 - (Math.pow(this.rtt, 0.1) - v) / y));
          this.quality = Math.min(100, Math.max(0, this.quality));
          this.raw_clock_skew = i - this.rtt / 2;
          this.clock_skew
            ? (this.clock_skew =
                0.9 * this.clock_skew + 0.1 * this.raw_clock_skew)
      ...
      a.prototype.add = function (e) {
        ...
        this.stddev = Math.sqrt(
          this.sq_sum / this.count - this.mean * this.mean
        );
      };
      var b = c.prototype;
      ...
      b.work = function () {
        for (
          var e,
            t,
            n,
            i = Date.now() + this.socket.options.MAX_BLOCKING_TIME_MS,
            o = !1,
            r = this.socket.recv_frames,
            s = this,
            a = 0;
          a < this.queue.length;
          a++
    ...
    function (e, t, n) {
      ...
      if (
        ...
        a.getAll = i(function (e) {
          for (
            var t, n = e.XMLDocument.documentElement.attributes, i = {}, r = 0;
            (t = n[r]);
            ++r
          ) {
            var s = o(t.name);
    ...
    function (e, t, n) {
      function i(e) {
        ...
        if (Y) H.$("status$string").update("reattached");
        else {
      ...
      function r(e) {
        ...
        if ("idle_disconnect" == e || "shutdown" == e || "error" == e) {
          var t = W.$("livechat").$("account").$("status$string").getValue(),
            n = W.$("connection").$("backoff"),
            i = n.$("active$int").getValue() || 0,
            o = n.$("max_seconds$int").getValue();
          "invalid_account_key" == t
            ? me.warnBadEmbed()
            : "widget_v2" == oe && "shutdown" == e && i && o && p(o);
          f();
        }
        L();
      }
      function s(e) {
        e &&
          (ie() ||
            fe.IS_POPOUT ||
            (e.mid$string && he.setIdentity(e.mid$string)));
      }
      function a(e) {
        ee = !0 === e;
      }
      ...
      function k() {
        var e = he.getIdentity(),
          t = ie(),
          n = W.$("livechat").$("ui").getValue("mobile$bool")
            ? "mobile"
            : "desktop",
          i = W.$("livechat").$("settings").$("theme").getValue("name$string"),
          o = {
            __type: "register",
        ...
        if (W.$("livechat").$("ui").$("popout$bool").getValue()) o.popout = !0;
        else {
          o.title = F.title;
      ...
      function L() {
        var e = H.getValue("status$string"),
          t = H.getValue("socket_status$string");
        window.clearTimeout(A.timer);
        if ("error" != e)
          if ("break" == t)
            if ("idle_disconnect" == e)
              H.update({
      ...
      function U() {
        ...
        (we = !1),
          ...
          (ke = 0),
          (Te = {}),
          (q = z = W = H = B = Y = X = Z = Q = J = ee = te = ne = ie = oe = re = se = ae = null);
      }
      var q,
        z,
        K,
      ...
      function i(e) {
        ...
        if (!n)
          return t
            ? new Error(
                t +
                  " type is not supported. Please upgrade the Web SDK version."
              )
            : new Error(
                'Structured message object should contain "type" property'
              );
        var i = n(e);
        if (i) {
        ...
        a = o.obj(
          {
            ...
            action: o.obj(
              {
                type: o.any([
                  o.equal(s.QUICK_REPLY_ACTION),
                  o.equal(s.LINK_ACTION),
                ]),
                value: o.type("string"),
              },
              {
    ...
    function (e, t, n) {
      function i(e, t) {
        if (!o(t.interval) || !o(t.limit))
          throw new Error("requires numeric interval and limit");
        if (t.callback && !r(t.callback))
          throw new Error("requires callback to be a function");
        return function () {
          var n = Date.now();
    ...
    function (e, t, n) {
      function i(e, t) {
        var n = a[e];
        n.module_function = new Function(
          "$Modules",
          t.toString().replace(d, "$1")
        );
        n.ready();
      }
      function o(e) {
      ...
      r.prototype.load = function () {
        ...
        for (t = 0; t < o.length; t++) {
          ...
          n.loader ||
            (n.loader = new u(
              c.baseURL + "/lib/" + c.build_number + "/" + n.fqname + ".js",
              a,
              e
            ));
        }
      ...
      function a(e, t) {
        if (u(t)) {
          ...
          throw new window.Error(
            "Invalid weights array: length does not match"
          );
        }
        if (l(t)) return c(e, t);
    ...
    function (e, t) {
      ...
      n.prototype._getOrCreateChildNode = function (e) {
        var t;
        if (i(this.childNodes, e)) t = this.childNodes[e];
        else {
          t = new n(e, this);
          this.childNodes[e] = t;
      ...
      n.prototype.unbindValue = function (e) {
        for (var t = this.getValueListeners(), n = 0; n < t.length; n++)
          if (t[n] == e) {
            t.splice(n, 1);
            return;
          }
      ...
      n.prototype.unbindKeys = function (e) {
        if (!this.leaf)
          for (var t = this.getKeysListeners(), n = 0; n < t.length; n++)
            if (t[n] == e) {
              t.splice(n, 1);
              return;
            }
      ...
      n.prototype.notifyWriteListeners = function (e) {
        if (this.listeners_write)
          for (
            var t = this.getWriteListeners().concat(), n = 0;
            n < t.length;
            n++
          )
            try {
      ...
      n.prototype.getValue = function (e) {
        ...
        for (var o in this.childNodes)
          if (null != (n = this.childNodes[o].getValue())) {
            i[o] = n;
            t = !0;
          }
        return t ? i : null;
      ...
      n.prototype.gc = function () {
        ...
        for (var t in this.childNodes) {
          ...
          e = n.leaf
            ? !(n.listeners_value && n.listeners_value.length) &&
              null == n.value &&
        ...
        return (
          e &&
          this.deleted &&
          !(this.listeners_keys && this.listeners_keys.length) &&
          !(this.listeners_value && this.listeners_value.length)
        );
      };
      n.DataNode = n;
      e.exports = n;
    ...
    function (e, t) {
      var n = function (e, t) {
          return (
            e === t ||
            (e && t && "object" == typeof e && "object" == typeof t && i(e, t))
          );
        },
        i = function (e, t) {
          var i;
    ...
    function (e, t, n) {
      function i(e) {
        de([ct], [e], "logout") ||
          (Be.isAuthenticated()
            ...
            : le(
                new Error(
                  "This API is only applicable for authenticated visitors"
                ),
                "logout"
              ));
      }
      ...
      function u() {
        "invalid_account_key" !== Ge.DOM.getVariable("account_status")
          ? "closed" === Qe.getConnectionStatus()
            ? ft()
            : le(
                new Error(
                  "Call has been ignored due to invalid connection status"
                ),
                "reconnect"
              )
          : Ue.warnBadEmbed();
          ...
          !de(
            [
              it.obj({
                display_name: it.any([
                  it.equal(""),
                  it.type("string").regex(st).maxLength(255),
                ]),
                email: it.any([
                  it.equal(""),
                  it.type("string").regex(Pe.email),
                ]),
                phone: at,
              }),
              ct,
      ...
      function g(e) {
        var t = it.type("number"),
          n = Ee.$("livechat");
        if (!de([t], [e], "getDepartment")) {
          n.$("account").$("departments_migrated$bool").getValue() &&
            n.$("dg_mappings").hasKey(e) &&
            console.warn(
              "legacy department id is deprecated, use group id %s instead",
              n.$("dg_mappings").$(e).$("group_id$int").getValue()
            );
          return _(e);
        }
      }
      ...
      function v() {
        var e = {},
          t = Ee.$("livechat");
        e = t.$("account").$("departments_migrated$bool").getValue()
          ? t.$("groups").getValue()
          : t.$("departments").getValue();
        return re(e, yt);
      }
      function y() {
        var e = Ee.$("livechat").$("profile").$("department_id$int"),
          t = e.getValue();
      ...
      function L(e, t, n, i) {
        if (
          !de(
            [it.each(it.type("string").regex(st).chain(ut)).minLength(1), ct],
            [t, i],
            n
          )
        ) {
      ...
      function A() {
        var e = Ee.$("livechat").$("channel").$("rating$string").getValue(),
          t = Ee.$("livechat").$("channel").$("comment$string").getValue(),
          n = {};
        Re(e) || (n.rating = e);
        Re(t) || (n.comment = t);
        return n;
      ...
      function I(e, t) {
        if (
          !de(
            [it.any([it.equal(null), it.equal("good"), it.equal("bad")]), ct],
            [e, t],
            "sendChatRating"
          )
        ) {
      ...
      function S() {
        return (
          Ee.$("livechat").$("channel").$("chatting$bool").getValue() || !1
        );
      }
      function D() {
      ...
      function V(e) {
        var t = $e.$("livechat").$("channel").$("typing"),
      ...
      function j(e, t) {
        var n = it.type("string").regex(Pe.email),
          i = !!Ee.$("livechat").$("channel").$("log").getKeys().length;
        if (!de([n, ct], [e, t], "sendEmailTranscript")) {
          ...
          Ee.$("livechat").$("channel").$("chatting$bool").getValue() || !1
            ...
            : le(
                new Error("There were no past chat to send a transcript of"),
                "sendEmailTranscript"
              );
        }
      }
        ...
        switch (e.type$string) {
          case "chat.msg":
            ...
            if ("structured_msg" in e) {
              ...
              var a = Ke.validate(s);
              a
                ? le(a, 'Unsupported structured message in "chat.msg" event')
                : (t.structured_msg = s);
            }
            return De.extend(t, {
              display_name: e.display_name$string,
      ...
      function H() {
        var e,
          t,
          n,
          i = ["type$string", "timestamp$int"],
          o = Ee.$("livechat").$("channel").$("log").getValue(),
          r = [];
        for (var s in o)
      ...
      function Y() {
        return (
          Ee.$("livechat").$("channel").$("queue_position$int").getValue() || 0
        );
      }
      function X(e) {
        if (!de([ct], [e], "fetchChatHistory"))
          if (Be.isAuthenticated()) {
            var t = Ee.$("livechat").$("history"),
              n = $e.$("livechat").$("history"),
              i = n.$("in_progress$bool").getValue(),
              o = t.$("has_more$bool").getValue(),
              r = t.$("cursor$string").getValue();
            if (i)
              le(
                new Error("Previous fetching of history is still in progress"),
                "fetchChatHistory"
              );
            else if (!1 !== o) {
              e = e || nt;
            ...
            le(
              new Error(
                "This API is not available for unauthenticated visitors"
              ),
              "fetchChatHistory"
            );
      }
      ...
      function te() {
        ...
        J(
          "visitor_update",
          "livechat.profile",
          se(["email$string", "phone$string", "display_name$string"], d)
        );
        J(
          "department_update",
          "livechat.departments",
          ae(["name$string", "status$string"], _)
        );
        J(
          "agent_update",
          "livechat.agents",
          ae(["avatar_path$string", "display_name$string", "title$string"], N)
        );
      ...
      function re(e, t) {
        var n = [];
        for (var i in e)
          Object.prototype.hasOwnProperty.call(e, i) && n.push(t(e[i], i));
        return n;
      }
      function se(e, t) {
        return function (n) {
      ...
      function le(e, t, n) {
        ...
        e.extra = n;
        Oe ||
          (window.console && window.console.error && console.error(e.message));
        ee("error", e);
      }
      function de(e, t, n) {
      ...
      function ge(e, t) {
        ...
        t.forEach(function (e) {
          ...
          t.forEach(function (t) {
            for (var n in o[t])
              Object.prototype.hasOwnProperty.call(o[t], n) &&
                Array.prototype.push.apply(i[e][n], o[t][n]);
          });
          for (n = 0; n < 7; n++) {
            var s = i[e][n];
        ...
        for (var o in e)
          if (Object.prototype.hasOwnProperty.call(e, o)) {
            ...
            for (var r in n.departments)
              if (Object.prototype.hasOwnProperty.call(n.departments, r)) {
      ...
      function ve(e) {
        ...
        for (var o in e)
          if (Object.prototype.hasOwnProperty.call(e, o)) {
            n = e[o];
            if (Object.prototype.hasOwnProperty.call(n, "deleted_ts$int"))
              continue;
      ...
      var be,
        ...
        ct = it.any([it.equal(void 0), it.type("function")]),
        ut = it.predicate(function (e) {
          return -1 === e.indexOf(",");
        }, "not contain any comma character"),
        lt = it.predicate(function (e) {
          return (
            "object" == typeof e.document &&
            !!e.document &&
            "object" == typeof e.navigator &&
            !!e.navigator &&
        ...
        ft = ze.rateLimit(c, dt),
        ht = ["email$string", "phone$string", "display_name$string"],
        pt = {
          connected: "connected",
        ...
        _t = ie(mt),
        vt = Q(ht),
        yt = Q(["name$string", "status$string"], "id", U),
        wt = Q(
          ["avatar_path$string", "display_name$string", "title$string"],
          "nick"
        ),
        bt = Q(["typing$bool"], "nick", q),
        $t = Q(["typing$bool"], "display_name", z),
        Et = Q(["timestamp$int"], null, W),
        kt = Q(["timestamp$int"], "nick", K),
        Tt =
          (Q([
            "banner",
            "behavior",
      ...
      for (var Ot in Qe)
        Object.prototype.hasOwnProperty.call(Qe, Ot) &&
          -1 === Tt.indexOf(Ot) &&
          Se(Qe[Ot]) &&
          (Qe[Ot] = (function (e, t) {
            return function () {
